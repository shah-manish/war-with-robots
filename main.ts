...
function spawnThings (mySprite: Sprite, num: number) {
    for (let index = 0; index < num; index++) {
        Robot = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . . . . . . . . . 
            `, SpriteKind.Enemy)
        Robot.setPosition(randint(-80, 80), randint(0, 0))
        Robot.setVelocity(randint(-35, 60), randint(-35, 60))
        Robot.setFlag(SpriteFlag.BounceOnWall, true)
    }
}
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite, otherSprite) {
    Robot.destroy(effects.confetti, 100)
    info.changeScoreBy(Math.abs(Robot.vx) + Math.abs(Robot.vy))
    spawnThings(Robot, 1)
})
